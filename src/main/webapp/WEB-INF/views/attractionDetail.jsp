...
<html>
  <head>
    ...
    <style>
 .body {
    background-image: url('https://media.cnn.com/api/v1/images/stellar/prod/220223041055-08-tripadvisor-top-10-beaches-world.jpg?q=h_1980,w_3000,x_0,y_0/w_1280');
