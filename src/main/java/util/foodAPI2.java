...
public class foodAPI2 {
	...
	public synchronized static busanFood getFoods(String pageNo) {
		try {
			...
			String queryString = "serviceKey=P%2FhL5EXdd%2FUh3HtYbHBtZI9PnkTMtbqImGmluwFnOgM%2FsLoypgqVKpFQ17t8zpHrnqoTMIh2ZJCJ2XOx7QFDnw%3D%3D&numOfRows=4&resultType=json&pageNo="+ pageNo;
