...
public class festivalAPI3 {
	
	
	public synchronized static busanFestival getIndexFestivals() {
		try {
			String target = "http://apis.data.go.kr/6260000/FestivalService/getFestivalKr";
			String queryString = "serviceKey=P%2FhL5EXdd%2FUh3HtYbHBtZI9PnkTMtbqImGmluwFnOgM%2FsLoypgqVKpFQ17t8zpHrnqoTMIh2ZJCJ2XOx7QFDnw%3D%3D&numOfRows=10&resultType=json";
