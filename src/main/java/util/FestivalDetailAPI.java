...
public class FestivalDetailAPI {

	
	public synchronized static busanFestival getFestivals(String UC_SEQ) {
		try {
			String target = "http://apis.data.go.kr/6260000/FestivalService/getFestivalKr";
			
			String queryString = "serviceKey=P%2FhL5EXdd%2FUh3HtYbHBtZI9PnkTMtbqImGmluwFnOgM%2FsLoypgqVKpFQ17t8zpHrnqoTMIh2ZJCJ2XOx7QFDnw%3D%3D&numOfRows=10&resultType=json&UC_SEQ="+UC_SEQ;
